...
class MiniCourt():
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self,player_boxes, ball_boxes, original_court_key_points ):
        player_heights = {
            ...
            3: constants.PLAYER_1_HEIGHT_METERS,
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            ...
            if ball_position is None:
                closest_player_id_to_ball = min(player_bbox.keys(), key=lambda x: get_height_of_bbox(player_bbox[x]))
            else:
            ...
            if len(output_ball_boxes) < len(output_player_boxes):
